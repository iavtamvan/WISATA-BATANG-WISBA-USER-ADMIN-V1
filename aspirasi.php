...
<div class="super_container">
    ...
    <div class="home">
        ...
        <div class="home_content">
            <div class="home_title">ASPIRASI</div>
        </div>
    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-1680-4">
                                    <div class="offers_image_container">
                                        ...
                                        <div class="offers_image_background" style="background-image:url('.$array['gambar_keluhan'].')"></div>
                                        <div class="offer_name"><a href="single_listing.html">'.$array['jenis_keluhan'].'</a></div>
                                    </div>
                                </div>
                                <div class="col-lg-8">
