...
<div class="super_container">
	...
	<div class="home">
		...
		<div class="home_content">
			<div class="home_title">USAHA / UMKM</div>
		</div>
	</div>
			...
			<div class="row">
				...
				<div class="col-lg-12">
					...
					<div class="offers_grid">
						...
						<!-- Offers Item -->
<?php
require 'Wisba-Admin-2/koneksi/config.php';
							...
							<div class="row">
								...
								<div class="col-lg-3 col-1680-4">
									<div class="offers_image_container">
										...
										<div class="offers_image_background" style="background-image:url('.$array['gambar_thumbnail_umkm'].')"></div>
										<div class="offer_name"><a href="single_listing.html">'.$array['kategori_umkm'].'</a></div>
									</div>
								</div>
								<div class="col-lg-8">
									<div class="offers_content">
										<div class="offers_price">'.$array['nama_umkm'].'<span></span></div>
										...
										<p class="offers_text">'.$array['detail_deskripsi_umkm'].'</p>
										...
										<div class="button book_button"><a href="#">Lokasi<span></span><span></span><span></span></a></div>
