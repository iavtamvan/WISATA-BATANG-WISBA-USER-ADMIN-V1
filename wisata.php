...
<div class="super_container">
				...
				<div class="row">
					<div class="col main_nav_col d-flex flex-row align-items-center justify-content-start">
						<div class="logo_container">
							<div class="logo"><a href="#"><img src="images/logo_64.png" alt=""></a></div>
						</div>
	...
	<div class="home">
		...
		<div class="home_content">
			<div class="home_title">Wisata Batang</div>
		</div>
	</div>
			...
			<div class="row">
				...
				<div class="col-lg-5">
					<div class="intro_content">
						<div class="intro_title">Wisata Batang</div>
						<p class="intro_text" style="text-align: justify">Batang merupakan sebuah Kabupaten di Jawa Tengah, Kabupaten ini memiliki sejuta pesona dan panaroma alam yang menakjubkan dan masih banyak yang tersembunyi, sehingga masih banyak orang yang belum mengetahui akan keindahan dan tempat keren yang ada di Batang. Batang punya banyak Spot objek wisata keren, mulai dari Situs budaya, situs bersejarah, spot foto foto kekinian , sampai air terjun yang sangat memanjakan mata dan harus segera kalian explore.</p>
						<div class="button intro_button"><div class="button_bcg"></div><a href="#">explore Sekarang<span></span><span></span><span></span></a></div>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="container">
			<div class="row">
				<div class="col text-center">
					<div class="section_title">Data Statistik</div>
				</div>
			</div>
			<div class="row">
				<div class="col-lg-10 offset-lg-1 text-center">
					<p class="stats_text">Statistik data pengunjung dari tahun ke tahun berdasarkan kategori wisata yang ada di walayah kota batang.</p>
				</div>
			</div>
			<div class="row">
				<div class="col">
						...
						<div class="stats_item d-flex flex-md-row flex-column clearfix">
							<div class="stats_last order-md-1 order-3">
								...
								<div class="stats_last_content">
									...
									<div class="stats_type">Wisata Budaya</div>
								</div>
							</div>
						...
						<div class="stats_item d-flex flex-md-row flex-column clearfix">
							<div class="stats_last order-md-1 order-3">
								...
								<div class="stats_last_content">
									...
									<div class="stats_type">Pariwisata Komersial</div>
								</div>
							</div>
						...
						<div class="stats_item d-flex flex-md-row flex-column clearfix">
							<div class="stats_last order-md-1 order-3">
								...
								<div class="stats_last_content">
									...
									<div class="stats_type">Wisata Sosial</div>
								</div>
							</div>
						...
						<div class="stats_item d-flex flex-md-row flex-column clearfix">
							<div class="stats_last order-md-1 order-3">
								...
								<div class="stats_last_content">
									...
									<div class="stats_type">Wisata Agama</div>
								</div>
							</div>
			...
			<div class="row">
				<div class="col">
					<div class="add_container">
						<div class="add_background" style="background-image:url(images/blog_background.jpg)"></div>
						<div class="add_content">
							<h1 class="add_title">Kabupaten Batang</h1>
							<div class="add_subtitle">Dari <span>Rp. 5000 </span></div>
							<div class="button add_button"><div class="button_bcg"></div><a href="#">explore sekarang<span></span><span></span><span></span></a></div>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="offers_grid">
						...
						<div class="row">
							...
							<div class="col-lg-8">
								<div class="offers_content">
									<div class="offers_price">$70<span>per tiket</span></div>
									...
									<div class="offer_reviews">
										<div class="offer_reviews_content">
											<div class="offer_reviews_title">Sangat Bagus</div>
											<div class="offer_reviews_subtitle">100 pengunjung / hari</div>
										</div>
					...
					<div class="offers_item rating_3">
						<div class="row">
							...
							<div class="col-lg-8">
								<div class="offers_content">
									<div class="offers_price">$50<span>per tiket</span></div>
					...
					<div class="offers_item rating_5">
						<div class="row">
							...
							<div class="col-lg-8">
								<div class="offers_content">
									<div class="offers_price">$110<span>per tiket</span></div>
					...
					<div class="offers_item rating_3">
						<div class="row">
							...
							<div class="col-lg-8">
								<div class="offers_content">
									<div class="offers_price">$90<span>per tiket</span></div>
									<div class="rating_r rating_r_3 offers_rating" data-rating="3">
										<i></i>
										<i></i>
										<i></i>
			...
			<div class="row">
				...
				<div class="col-lg-3 milestone_col">
					<div class="milestone text-center">
						...
						<div class="milestone_counter" data-end-value="1255">0</div>
						<div class="milestone_text">Pengunjung</div>
					</div>
				</div>
				...
				<div class="col-lg-3 milestone_col">
					<div class="milestone text-center">
						...
						<div class="milestone_counter" data-end-value="176">0</div>
						<div class="milestone_text">Program</div>
					</div>
				</div>
				...
				<div class="col-lg-3 milestone_col">
					<div class="milestone text-center">
						...
						<div class="milestone_text">Wilayah</div>
					</div>
				</div>
				...
				<div class="col-lg-3 milestone_col">
					<div class="milestone text-center">
						...
						<div class="milestone_text">Warung</div>
					</div>
				</div>
